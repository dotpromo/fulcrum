class Project < ActiveRecord::Base
  JSON_ATTRIBUTES = %w(id iteration_length iteration_start_day start_date default_velocity)
  JSON_METHODS = %w(last_changeset_id point_values)
    ...
    def from_csv(csv_string)
      ...
      csv.map do |row|
        ...
        story = create(
          ...
          requested_by: users.find { |u| u.name == row['Requested By'] },
          owned_by: users.find { |u| u.name == row['Owned By'] },
